...
%
Please go to the \file{Day-1/} directory.
\begin{itemize}
\item \cmd{cd example0.QE-compilation/}  
\end{itemize}
...
\item the scheme to calculate and plot the charge-density is:
  ...
  \item plot the charge density by \prog{xcrysden} (follow the
    instructions of tutor)
  \end{enumerate}
\end{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
\head{Magnetic structures: going antiferomagnetic}
\begin{itemize}
