...
using \prog{pwtk}. Run this calculation by typing:
...
\exec{remote\_pwtk scan.pwtk}

After calculation finishes, download the output and data files as:\\
\exec{rsync\_from\_nsc *.out *.dat}

The plot the result with gnuplot.
